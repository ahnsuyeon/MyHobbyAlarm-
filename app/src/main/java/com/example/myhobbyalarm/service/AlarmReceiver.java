...
import static com.example.myhobbyalarm.ui.AddEditJournalActivity.launchIntent;
...
public final class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        builder.setContentIntent(AddEditJuournalActivity(context, alarm));
    ...
    private static PendingIntent AddEditJuournalActivity(Context ctx, Alarm alarm) {
    ...
    private static class ScheduleAlarm {
        ...
        void schedule(Alarm alarm, PendingIntent pi) {
            ...
            if(SDK_INT > LOLLIPOP) {
                am.setAlarmClock(new AlarmClockInfo(alarm.getTime(), AddEditJuournalActivity(ctx, alarm)), pi);
